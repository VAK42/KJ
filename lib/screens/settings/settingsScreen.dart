      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                const CircleAvatar(radius: 28, backgroundColor: AppTheme.accent, child: Icon(Icons.person_rounded, size: 32, color: Colors.white)),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Account Status: OK', style: TextStyle(fontSize: 12, color: AppTheme.success.withValues(alpha: 0.8))),
                    ],
                  ),
                ),
              ],
          ...
          const _SettingsTile(icon: Icons.code_rounded, title: 'Made With Flutter', subtitle: 'Uses Fastify + SQLite Backend'),
          const SizedBox(height: 32),
